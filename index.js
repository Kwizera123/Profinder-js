...
const CLIENT_ID = '710a20d8005354c80569';
const CLIENT_SECRET = '953884c2a0da42f49b05b04441527a221d5ce2d0';
// fetch(`https://api.github.com/users/andrew`).then((res)=>res.json()).then(
// (profile)=>console.log(profile)); (Closed/Deleted during studies by Kazi)
...
async function getRepos(profile){
  ...
  client_secrect=${CLIENT_SECRET}&per_page=10`);
